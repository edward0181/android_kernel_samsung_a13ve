deps_config := \
	...
	drivers/input/touchscreen/himax/hx83xxx_spi/Kconfig \
...
ifneq "$(CC)" "../clang/bin/clang"
include/config/auto.conf: FORCE
endif
ifneq "$(LD)" "/home/edward/lineage/kernel/samsung/a13ve/gcc/bin/aarch64-buildroot-linux-gnu-ld"
include/config/auto.conf: FORCE
endif
ifneq "$(NM)" "/home/edward/lineage/kernel/samsung/a13ve/gcc/bin/aarch64-buildroot-linux-gnu-nm"
include/config/auto.conf: FORCE
endif
ifneq "$(OBJCOPY)" "/home/edward/lineage/kernel/samsung/a13ve/gcc/bin/aarch64-buildroot-linux-gnu-objcopy"
include/config/auto.conf: FORCE
endif
ifneq "$(CLANG_FLAGS)" "--target=aarch64-buildroot-linux-gnu --prefix=/home/edward/lineage/kernel/samsung/a13ve/gcc/bin/aarch64-buildroot-linux-gnu- --gcc-toolchain=/home/edward/lineage/kernel/samsung/a13ve/gcc -no-integrated-as -Werror=unknown-warning-option -fno-builtin-stpcpy"
include/config/auto.conf: FORCE
endif
ifneq "$(SRCARCH)" "arm64"
include/config/auto.conf: FORCE
